...
use App\Models\BaiViet; // Man create 30/01/2022 
...
class HinhBaiVietController extends Controller
{
    ...
    public function layHinhBaiViet(Request $request)  // Man create 30/01/2022
    {                                            
        return response([
            'hinhAnh' => HinhBaiViet::with('hinhbaiviet')->get()
        ], 200);
    }
