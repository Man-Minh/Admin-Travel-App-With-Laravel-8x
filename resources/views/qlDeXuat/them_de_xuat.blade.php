...
<div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Thêm Đề Xuất Vào Địa Danh</h4>
                    <p class="card-description">  </p>
                    <form class="forms-sample" action="{{route('admin.xulydexuat',['id'=>$deXuat->id])}}" method="POST"  enctype="multipart/form-data" >
                      @csrf
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" value="{{$deXuat->ten_Diem}}" name="ten_dia_danh" class="form-control" id="exampleInputName1" placeholder="Name">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">Tên Khác</label>
                        <input type="text" value="{{$deXuat->ten_Goi_Khac}}" name="ten_Goi_Khac" class="form-control" id="exampleInputName1" placeholder="Name">
                      </div>
                      
                      <div class="form-group">
                        <label for="exampleInputName1">Kinh độ</label>
                        <input name="kinh_Do" type="text" value="{{$deXuat->kinh_Do}}" class="form-control" id="exampleInputName1" placeholder="Name">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">Vĩ độ</label>
                        <input name="vi_Do" type="text" value="{{$deXuat->vi_Do}}" class="form-control" id="exampleInputName1" placeholder="Name">
                      </div>
                      <div class="form-group">
                      ...
                      <div  class="form-group" style="width: 200px; height: auto; display: flex;">
                      <img style="width: auto; height: 100px;" src="{{$deXuat->img}}" style="width:200px" alt="">
