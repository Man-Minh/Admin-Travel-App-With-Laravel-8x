...
<div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Cập Nhật Địa Danh</h4> 
                    <p class="card-description">  </p>
                    <form class="forms-sample" action="{{route('admin.patchdiadanh', ['id'=>$dsDiaDanh->id,'dsDiaDanh'=>$dsDiaDanh])}}" method="POST"  enctype="multipart/form-data" >
                    @csrf
                    @method('PATCH')
                      <div class="form-group">
                        <label for="exampleInputName1">Tên địa danh</label>
                        <input type="text" name="ten_dia_danh" class="form-control" id="exampleInputName1" value="{{$dsDiaDanh->ten_dia_danh}}">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">Tên Khác</label>
                        <input type="text" name="ten_Goi_Khac" class="form-control" id="exampleInputName1" value="{{$dsDiaDanh->ten_Goi_Khac}}">
                      </div>
                      
                      <div class="form-group">
                        <label for="exampleInputName1">Kinh độ</label>
                        <input name="kinh_Do" type="text" class="form-control" id="exampleInputName1" value="{{$dsDiaDanh->kinh_Do}}" >
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">Vĩ độ</label>
                        <input name="vi_Do" type="text" class="form-control" id="exampleInputName1" value="{{$dsDiaDanh->vi_Do}}" >
                      </div>
                      <div class="form-group">
                        ...
                        <select class="form-control" name="mien_id" id="exampleSelectGender">
                          ...
                          <option value="{{$mien->id}}" @if($mien->id == $dsDiaDanh->thongTinMien->id) selected @endif  >
                            {{$mien->ten_Mien}}
                          </option>
                          @endforeach
                        </select>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="phan_vung_id" id="exampleSelectGender">
                          ...
                          <option value="{{$phanVung->id}}" @if($phanVung->id == $dsDiaDanh->thongTinVung->id) selected @endif >
                            {{$phanVung->ten_Vung}}
                          </option>
                          @endforeach
                        </select>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="loai_dia_danh_id" id="exampleSelectGender">
                          ...
                          <option value="{{$LoaiDiaDanh->id}}" @if($LoaiDiaDanh->id == $dsDiaDanh->thongTinLoaiDiaDanh->id) selected @endif  >
                      ...
                      <div class="form-group">
                        <a href="{{route('admin.hinhdiadanh',['id'=>$dsDiaDanh->id])}}">Cập nhật ảnh</a>
                      </div>
                      
                      <div class="form-group">
                        <label for="exampleTextarea1">Mô tả</label>
                        <textarea name="mo_Ta" class="form-control" id="exampleTextarea1" rows="4"> {{$dsDiaDanh->mo_Ta}} </textarea>
                      </div>
