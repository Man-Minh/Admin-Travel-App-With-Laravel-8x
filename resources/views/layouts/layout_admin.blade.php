      ...
      <aside class="main-sidebar col-12 col-md-3 col-lg-2 px-0">
        ...
        <div class="nav-wrapper">
          <ul class="nav flex-column">
            <li class="nav-item">
              <a class="nav-link active" href="{{route('admin.thongke')}}" style="box-shadow: none;">
          ...
          <nav class="navbar align-items-stretch navbar-light flex-md-nowrap p-0">
            <form action="" class="main-navbar__search w-100 d-none d-md-flex d-lg-flex">
              <div class="input-group input-group-seamless ml-3">
                <div class="input-group-prepend">
                  <div class="input-group-text">
                  <button type="submit" class="btn" style="background-color:white;" ><i class="fas fa-search"></i></button>  
                  </div>
                </div>
                <input class="navbar-search form-control" name="key" type="text" placeholder="Search for something..."
                  aria-label="Search">
              </div>
            </form>
            <ul class="navbar-nav border-left flex-row ">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle text-nowrap px-3" data-toggle="dropdown" href="#" role="button"
                  ...
                  @auth  <img class="user-avatar rounded-circle mr-2"  src="{{session('img')}}" alt="User Avatar">  @endauth <!--Man update 06/02/2022-->
                  <span class="d-none d-md-inline-block">@auth {{Auth::user()->name}} @endauth</span> <!--Man update 06/02/2022-->
                </a>
                <div class="dropdown-menu dropdown-menu-small">
                @auth <a class="dropdown-item" href="{{route('admin.capnhattaiKhoan',['id'=>Auth::user()->id])}}">  @endauth
